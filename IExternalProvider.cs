namespace BurcatProtocol
{
    ...
    public interface IExternalProvider
    {
        ...
        Task<Guid> GetRevision(BurcatRelayHead head, Type objectType, Guid objectID, CancellationToken token);
        ...
        Task<IBurcatObject?> GetObject(BurcatRelayHead head, Type objectType, Guid objectID, CancellationToken token);
        ...
        Task<BurcatException?> CoupleCache(BurcatRelayHead head, IBurcatObject objectBDP, bool explicitelyRequested, CancellationToken token);
        ...
        /// <param name="token">The cancellation token.</param>
        /// <returns><see langword="null"/> on success; otherwise, the protocol exception describing the failure.</returns>
        Task<BurcatException?> DecoupleCache(BurcatRelayHead head, IBurcatObject objectBDP, CancellationToken token);
        ...
        Task<ActionResult> ExecuteAction(BurcatRelayHead head, Type objectType, IBurcatObject? objectBDP, string action, object?[]? parameters, CancellationToken token);
    }
}
